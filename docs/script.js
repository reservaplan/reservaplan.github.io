...
const allPlans = [
    ...
    function renderCategory(plans, containerElement) {
        ...
        plans.forEach(plan => {
            ...
            const whatsappMessage = `https://wa.me/573163286141?text=Hola,%20quisiera%20más%20información%20sobre%20el%20alojamiento:%20${encodeURIComponent(plan.nombre)}`;
...
let infoHTML;
        if (plan.detalles) {
             ...
             const whatsappMessage = `https://wa.me/573163286141?text=Hola,%20quisiera%20cotizar%20el%20alojamiento%20${encodeURIComponent(plan.nombre)}%20(Código:%20${plan.codigo})`;
             ...
             const whatsappMessage = `https://wa.me/573163286141?text=Hola,%20quisiera%20cotizar%20el%20alojamiento%20${encodeURIComponent(plan.nombre)}`;
